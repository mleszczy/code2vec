...
set -x 
TRAIN_DIR=/dfs/scratch1/mleszczy/mlcompilers/code2vec/java-small/training
VAL_DIR=/dfs/scratch1/mleszczy/mlcompilers/code2vec/java-small/validation
TEST_DIR=/dfs/scratch1/mleszczy/mlcompilers/code2vec/java-small/test
DATASET_NAME=java-small-ast
MAX_CONTEXTS=200
